...
function UploadResume() {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const response = await fetch(`${BACKEND_BASE_URL}/api/analyze-resume`, {
        method: "POST",
        body: formData,
      });
  ...
  return (
    ...
    >
      ...
      <div className="w-full max-h-full bg-slate-50/80 backdrop-blur-3xl rounded-3xl shadow-[0_0_40px_rgba(0,0,0,0.5)] border border-slate-200/50 overflow-hidden flex flex-col md:flex-row relative z-10">
        ...
        <div
          className="w-full md:w-1/2 p-6 md:p-10 border-b md:border-b-0 md:border-r border-slate-200/30 flex flex-col justify-center relative overflow-y-auto bg-slate-50/50"
          ...
          <div className="relative z-10 flex flex-col h-full">
            <div className="mb-6">
              ...
              <p className="text-slate-500 text-sm leading-relaxed max-w-sm">
                Our AI instantly parses your document to build a highly
                tailored, role-specific technical interview environment.
              </p>
            </div>
                ...
                {file ? (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="p-1.5 bg-indigo-500/20 hover:bg-indigo-500/40 rounded-full text-indigo-300 hover:text-white transition-colors ml-2 flex-shrink-0"
                    >
                      <svg
                        className="w-4 h-4"
                        fill="none"
        ...
        <div
          className="w-full md:w-1/2 p-6 md:p-10 flex flex-col bg-white overflow-y-auto relative"
          style={{ scrollbarWidth: "none" }}
        >
            ...
            <div className="space-y-6 flex-1">
              <div>
                <label className="flex items-center justify-between text-sm font-bold text-slate-700 mb-3">
                  ...
                  <span className="text-indigo-500 bg-indigo-500/10 border border-indigo-500/20 px-2 py-0.5 rounded-md text-xs">
                    {difficulty}
                  </span>
                </label>
              ...
              <div>
                <label className="flex justify-between items-center text-sm font-bold text-slate-700 mb-4">
                  ...
                  <span className="text-xl font-black text-slate-900 w-8 text-right">
                    {questionCount}
                  </span>
                </label>
            ...
            <div className="mt-6 pt-6 border-t border-slate-100">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-2 text-sm text-slate-500 font-medium">
                  <svg
                    className="w-5 h-5 opacity-70 text-indigo-400"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
              ...
              >
                {isUploading ? (
                  <>
                    <svg
                      className="animate-spin h-5 w-5 opacity-70 border-2 border-slate-500 border-t-slate-50 rounded-full"
                      viewBox="0 0 24 24"
                    ></svg>
